...
<div class="mb-4 p-4 <?= $config['bg'] ?> border-l-4 <?= $config['border'] ?> rounded-r-lg flex items-start <?= $dismissible ? 'relative' : '' ?>" role="alert">
    ...
    <?php if ($dismissible): ?>
    <button type="button" class="ml-3 flex-shrink-0 <?= $config['text'] ?> hover:opacity-75 focus:outline-none" onclick="this.parentElement.remove()">
